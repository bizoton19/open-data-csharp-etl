...
$outputPath="G:\USERS\EXIS\$env:username\IncidentData\$outputFileNameWithoutExtension.$format";

$startDate = "01/01/2000"#[DateTime]::Parse($startDateInput);
$endDate= "01/30/2015" #[DateTime]::Parse($endDateInput);
$url = "http://rmspreprodweb2/incidentData/api/IncidentReports?page=$page";
 $doc
...
for($start=1; $start -le 564 ; $start++){
$page++
$batch+=50
$outputPath="G:\USERS\EXIS\$env:username\IncidentData\$outputFileNameWithoutExtension$batch.$format";
 $url = "http://rmspreprodweb1/incidentData/api/IncidentReports?page=$page";
